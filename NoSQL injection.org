:PROPERTIES:
:ID:       5e522dd9-15ad-492d-9462-2c14cc6ad8a6
:END:
#+title: NoSQL injection
#+created: [2025-10-27 Mon 09:16]
#+filetags: :cyber::no-sql-injection:
* NoSQL injection
...
- solution:
  I used %27%7c%7c%27%31%27%3d%3d%27%31 at the end of the category query and it showed me all products.
*** Continued
...
- solution:
  I had to use the query:
  admin' && this.password[0] == 'a' || 'a'=='b
  on the username lookup, I then did a cluster bomb attack with burp intruder to find the password.
